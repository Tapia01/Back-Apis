...
const CatalogoPantalones = () => {
    // Aquí debes pasar el ID adecuado para el tipo de producto "Blusas"
    const { products, loading, error } = useFetchProductsByType(5); // 4 es un ejemplo, reemplázalo con el ID real
    ...
    return (
        <div className="catalogo-container">
            <h2 className="catalogo-titulo">Catálogo de pantalones</h2>
